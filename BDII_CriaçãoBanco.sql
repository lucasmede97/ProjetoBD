...
sexo_Funcionario char(1) not null check(sexo_Funcionario like'[FM]'))
GO
...
sexo_Usuario char(1) check(sexo_Usuario like'[FM]'),
...
ano_Material varchar(5) constraint UN4_TblMaterial unique not null,
CDU_Material varchar(40) constraint UN5_TblMaterial unique,
Cutter_Material varchar(15) constraint UN6_TblMaterial unique,
...
GO
 ...
 nome_Funcionario varchar(95) constraint FK4_TblEmprestimo_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 tombo_Exemplar varchar(10) constraint FK5_TblEmprestimo_TblExemplar foreign key references TblExemplar(tombo_Exemplar) not null,
 titulo_Material varchar(200) constraint FK6_TblEmprestimo_TblMaterial foreign key references TblMaterial(titulo_Material) not null,
 DTPrevista_Devolução datetime not null,
 DTEmprestimo datetime not null)
 GO

 create table TblDevolução(
 matricula_Usuario varchar(15) constraint PK_TblDevolução primary key constraint FK1_TblDevolução_TblUsuario references TblUsuario(matricula_Usuario) not null,
 codigo_Funcionario int constraint FK3_TblDevolução_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 tombo_Exemplar varchar(10) constraint FK5_TblDevolução_TblExemplar foreign key references TblExemplar(tombo_Exemplar) not null,
 titulo_Material varchar(200) constraint FK6_TblDevolução_TblMaterial foreign key references TblMaterial(titulo_Material) not null,
 DTDevolução datetime not null)
 GO 

 create table TblReserva(
 matricula_Usuario varchar(15) constraint PK_TblReserva primary key constraint FK1_TblReserva_TblUsuario references TblUsuario(matricula_Usuario) not null,
 codigo_Funcionario int constraint FK3_TblReserva_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 tombo_Exemplar varchar(10) constraint FK5_TblReserva_TblExemplar foreign key references TblExemplar(tombo_Exemplar) not null,
 titulo_Material varchar(200) constraint FK6_TblReserva_TblMaterial foreign key references TblMaterial(titulo_Material) not null,
 DTReserva datetime not null,
 DTLimite_Reserva datetime not null)
 GO

 create table TblRevista(
 DTPublicaçao_Revista datetime constraint PK_TblRevista primary key not null,
 tipo varchar(20) not null)
 GO

 create table TblControla_Editora(
 codigo_Funcionario int constraint PK_TblControla_Editora primary key constraint FK1_TblControla_Reserva_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 nome_Funcionario varchar(95) constraint FK2_TblControla_Editora_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 DTAltera datetime not null)
 GO

 create table TblControla_Fornecedor(
 codigo_Funcionario int constraint PK_TblControla_Fornecedor primary key constraint FK1_TblControla_Fornecedor_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 nome_Funcionario varchar(95) constraint FK2_TblControla_Fornecedor_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 DTAltera datetime not null)
 GO

 create table TblControla_Material(
 codigo_Funcionario int constraint PK_TblControla_Material primary key constraint FK1_TblControla_Material_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 nome_Funcionario varchar(95) constraint FK2_TblControla_Material_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 DTAltera datetime not null)
 GO

 create table TblControla_Usuario(
 codigo_Funcionario int constraint PK_TblControla_Usuario primary key constraint FK1_TblControla_Usuario_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 nome_Funcionario varchar(95) constraint FK2_TblControla_Usuario_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 DTAltera datetime not null)
 GO

 create table TblControla_Pedido_Material(
 codigo_Funcionario int constraint PK_TblControla_Pedido_Material primary key constraint FK1_TblControla_Pedido_Material_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 nome_Funcionario varchar(95) constraint FK2_TblControla_Pedido_Material_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 DTAltera datetime not null)
 GO

 create table TblControla_Fucnionario(
 codigo_Funcionario int constraint PK_TblControla_Fucnionario primary key constraint FK1_TblFucnionario_Material_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 nome_Funcionario_ADM varchar(95) constraint FK2_TblControla_Fucnionario_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 nome_Funcionario_alterado varchar(95) constraint FK3_TblControla_Fucnionario_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 DTAltera datetime not null)
 GO

 create table Controla_Curso(
 codigo_Funcionario int constraint PK_Controla_Curso primary key constraint FK1_TblControla_Curso_TblFuncionario foreign key references TblFuncionario(codigo_Funcionario) not null,
 nome_Funcionario varchar(95) constraint FK2_TblControla_Curso_TblFuncionario foreign key references TblFuncionario(nome_Funcionario) not null,
 DTAltera datetime not null)
 GO